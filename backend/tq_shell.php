...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $management_password = 'whataf3hintime';

    if ($password === $management_password) {
        $_SESSION['management_tq'] = true;
        header('Location: tqshell/manage.php');
        exit;
    }
...
<head>
  ...
  <title>Management: TQShell - Spanning Tree Corporation</title>
...
<body class="backend">
  <div class="login-container">
    ...
    <?php endif; ?>
    <form action="tq_shell.php" method="post">
